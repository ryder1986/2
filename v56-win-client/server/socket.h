...
//        int so_broadcast=1;
//        setsockopt(socket_fd,SOL_SOCKET, SO_BROADCAST, (const char *) &so_broadcast,sizeof(so_broadcast));
//        if((1==bind(socket_fd,(struct sockaddr *)&user_addr,sizeof(struct sockaddr)))){
//            perror("bind");
//            return -1;
//        }
