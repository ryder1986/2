...
#define DECODE_OBJ_ARRAY_MEM(mem)  {auto tmp=config.get_array_packet(#mem);this->mem.assign(tmp.begin(),tmp.end());}



#define INIT_OBJ_MEM(mem)  {this->mem=config.get_pkt(#mem);}
